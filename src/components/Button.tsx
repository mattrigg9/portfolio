...
const BUTTON_CLASSES =
  "rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600";
...
export function LinkButton({ children, ...props }: LinkButtonProps) {
  return (
    <a {...props} className={classNames(BUTTON_CLASSES, props.className)}>
      {children}
    </a>
  );
}
